            ...
            <div class="card-body">
                ...
                <form action="{{ route('event.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row ">
                            <div class="form-group col-md-6">
                                <input type="text" class="form-control" id="date" name="start_on_date"
                                    placeholder="Dari Tanggal" value="{{ old('start_on_date') }}">
                            </div>
                            <div class="form-group col-md-6">
                                <input type="text" class="form-control" id="date2" name="until_date"
                                    placeholder="Sampai Tanggal" value="{{ old('until_date') }}">
                            </div>
                        </div>
                        <div class="form-row ">
                            <div class="form-group col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="address" name="address" placeholder="Alamat" class="form-control"
                            rows="10">{{ old('address') }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="city">Kota</label>
                        <input type="city" class="form-control" name="city" placeholder="Kota" value="{{ old('city') }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="term_and_conditions" name="term_and_conditions"
                            rows="10">{{ old('term_and_condition') }}</textarea>
                    </div>
