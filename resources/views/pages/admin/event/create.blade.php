        ...
        <div class="card-body">
            ...
            <form action="{{ route('event.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea id="address" name="address" placeholder="Alamat" class="form-control" rows="10">{{ old('address') }}</textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea id="term_and_conditions" name="term_and_conditions" rows="10">{{ old('term_and_condition') }}</textarea>
                </div>
